...
const HomeMainIntroDesktop = (props) => {
  ...
  return (
    ...
    >
      <Flex flexDirection={"column"} w={"650px"} gap={"100px"}>
        <Heading
          textAlign={"left"}
          fontWeight={"light"}
          fontSize={"7xl"}
        ...
        <form onSubmit={submitEmail}>
          ...
          >
            <Flex>
              ...
              <Heading fontWeight={"medium"} fontSize={"3xl"} color={"#EDF2F7"}>
                |
              </Heading>
            </Flex>
          </Button>
...
export default HomeMainIntroDesktop;
